...
ob_start();
session_start();
$url_base = "http://192.168.1.17/sistemacondomino/";
...
// INICIO: LÓGICA PARA OBTENER FECHA ACTUAL Y VARIABLES DE SESIÓN

// 1. Obtener el mes y el año ACTUALES del sistema
// Usamos date('Y') para el año (ej: 2024)
$aniio = date('Y');

// Usamos date('F') para el nombre del mes en inglés (ej: December) y lo traducimos al español
...
$mes = $meses_es[$mes_actual_en] ?? $mes_actual_en; // Mes en español
...
$usuario_rol = $_SESSION['usuario_rol'] ?? 'Usuario Responsable';

// 2. Actualizar variables de sesión con la fecha actual (Opcional, pero recomendado si las usas después)
$_SESSION['mes'] = $mes;
$_SESSION['anio'] = $aniio;

// FIN: LÓGICA PARA OBTENER FECHA ACTUAL Y VARIABLES DE SESIÓN
...
if ($_POST && isset($_POST['condominio_id'])) {
  ...
  if ($registro) {
    ...
    // No leemos mes/anio de $registro. Usamos las variables $mes y $aniio que 
    // ya fueron establecidas al inicio con la fecha ACTUAL del sistema.
    $_SESSION['mes'] = $mes;
    $_SESSION['anio'] = $aniio;
...
<head>
  ...
  <link rel="stylesheet" href="<?php echo $url_base; ?>css/fondo.css">
    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-custom ">
      <div class="container-fluid">
        ...
        <a class="navbar-brand" href="<?php echo $url_base; ?>index.php">
          <img src="<?php echo $url_base; ?>img/logo.png" alt="" width="60" height="60">
          <span>ALPLAME</span>
        </a>
          ...
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item dropdown user-dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-end">
                ...
                <li><a class="dropdown-item" href="<?php echo $url_base; ?>secciones/usuarios/mi_actividad.php"><i class="fas fa-user me-2"></i> Mi Perfil</a></li>
          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item" href="<?php echo $url_base; ?>secciones/pagos/gestionar_moras.php">Moras</a></li>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" target="_blank" href="<?php echo $url_base; ?>secciones/reportes/reportes.php">Reportes</a></li>
                <li><a class="dropdown-item" target="_blank" href="<?php echo $url_base; ?>secciones/estado_de_resultado/generar_pdf_estado.php">Estado de Resultado</a></li>
              </ul>
            </li>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item" href="<?php echo $url_base; ?>secciones/configuracion/editar_ticket.php">Editar Tikets</a></li>
                <li><a class="dropdown-item" href="<?php echo $url_base; ?>secciones/configuracion/edit_pdf_estado.php">Estado de resultado</a></li>
                <li><a class="dropdown-item" href="<?php echo $url_base; ?>secciones/reportes/log_correos.php">Correos Enviados</a></li>
              </ul>
            </li>
    ...
    <nav aria-label="breadcrumb" class="bg-white shadow-sm py-2 px-3 border-bottom">
      <div class="container-fluid d-flex justify-content-between align-items-center">
        ...
        <ol class="breadcrumb mb-0">
          <a href="<?php echo $url_base; ?>secciones/gas/index.php" class="text-decoration-none">
            <span class="badge rounded-pill bg-dark shadow-sm">
              <i class="fas fa-circle me-1"></i>Gas
            </span>
          </a>
          <a href="<?php echo $url_base; ?>secciones/cuotasextras/index.php" class="text-decoration-none">
            <span class="badge rounded-pill bg-dark shadow-sm">
              <i class="fas fa-circle me-1"></i>Cuotas
            </span>
          </a>
          <a href="<?php echo $url_base; ?>secciones/pagos/gestionar_moras.php" class="text-decoration-none">
            <span class="badge rounded-pill bg-dark shadow-sm">
              <i class="fas fa-circle me-1"></i>Moras
            </span>
          </a>
        </ol>

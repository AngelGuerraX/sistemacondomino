...
if ($_POST) {
  ...
  //preparar insercion
  $sentencia = $conexion->prepare("INSERT INTO tbl_aptos (apto,condominos,mantenimiento,gas,correo,telefono,forma_de_pago,fecha_ultimo_pago, id_condominio)
    VALUES (:apto, :condominos, :mantenimiento, :gas, :correo, :telefono, :forma_de_pago, :fecha_ultimo_pago, :idcondominio)");

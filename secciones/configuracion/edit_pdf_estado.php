    ...
    <form action="" method="post" enctype="multipart/form-data">
        <?php foreach ($lista_condominio as $registro) { ?>
            <div class="form-check">
                <input class="form-check-input" type="checkbox" value="" id="mora" name="mora" <?php if ($registro['mora'] === 'si') {echo "checked";} ?>>
                <label class="form-check-label" for="flexCheckDefault">Moras</label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="checkbox" value="" id="gas" name="gas" <?php if ($registro['gas'] === 'si') {echo "checked";} ?>>
                <label class="form-check-label" for="flexCheckDefault1">Gas</label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="checkbox" value="" id="cuota" name="cuota" <?php if ($registro['cuota'] === 'si') {echo "checked";} ?>>

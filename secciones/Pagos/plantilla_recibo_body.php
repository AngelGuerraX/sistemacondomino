        ...
        <div class="mt-5 pt-5">
            <div class="row">
                <div class="col-6 text-center">
                    <div class="border-top border-dark w-75 mx-auto pt-2">Firma Recibido Conforme</div>
                </div>
                <div class="col-6 text-center">
                    <div class="border-top border-dark w-75 mx-auto pt-2">Firma Administración</div>
                </div>
            </div>
        </div>
